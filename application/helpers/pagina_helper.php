...
<head>
	...
	<title>'.$titulo.'</title>
	<!-- JQuery UI-->
	<link rel="stylesheet" href="//localhost/solaris/resources/jquery-ui-1.11.2/jquery-ui.css" />
	<script src="//localhost/solaris/resources/jquery-ui-1.11.2/jquery-ui.min.js"></script>
